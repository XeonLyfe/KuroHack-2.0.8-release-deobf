...
public class PlayerUtil implements IUtil
{
    ...
    public static class lookUpUUID implements Runnable
    {
        ...
        public void run() {
            ...
            try {
                final ArrayList<NetworkPlayerInfo> infoMap = new ArrayList<NetworkPlayerInfo>(Objects.requireNonNull(IUtil.mc.getConnection()).getPlayerInfoMap());
    ...
    public static class lookUpName implements Runnable
    {
        ...
        public String lookUpName() {
            ...
            if (IUtil.mc.world != null) {
                player = IUtil.mc.world.getPlayerEntityByUUID(this.uuidID);
            }
            if (player == null) {
