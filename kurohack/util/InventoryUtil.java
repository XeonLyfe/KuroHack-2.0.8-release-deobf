...
public class InventoryUtil implements IUtil
{
    ...
    public static class Task
    {
        ...
        public void run() {
            if (this.update) {
                IUtil.mc.playerController.updateController();
            }
            if (this.slot != -1) {
                IUtil.mc.playerController.windowClick(IUtil.mc.player.inventoryContainer.windowId, this.slot, 0, this.quickClick ? ClickType.QUICK_MOVE : ClickType.PICKUP, (EntityPlayer)IUtil.mc.player);
            }
        }
